        ...
        for x in range(self.__img.shape[0]):
            for y in range(self.__img.shape[1]):
                ...
                if (new_pos[1] > 0 and new_pos[1] < self.__dst_shape[0] and
                    ...
                    if (new_pos[1] < self.__dst_shape[0] - 1 and
                            new_pos[0] < self.__dst_shape[1] - 1):
                        ret_img[new_pos[1] + 1, new_pos[0] +
                                1] = self.__img[x, y]
                    if (new_pos[1] < self.__dst_shape[0] - 1):
                        ret_img[new_pos[1] +
                                1, new_pos[0]] = self.__img[x, y]
                    if (new_pos[0] < self.__dst_shape[1] - 1):
                        ret_img[new_pos[1], new_pos[0] +
                                1] = self.__img[x, y]
        return ret_img
